...
| 2P cells segmented in the plane | ~1,440 |
| 2P cells matched 1:1 | ~1,200 — **~83% of segmented cells, ~91% of those that overlap** |
| 2P cells soma-print called confidently | ~1,160 |
| best-match median IoU (at 2P z) | ~0.30 |
