...
Suite2p prints `pynwb not installed, save_nwb, read_nwb, and nwb_to_binary will not work`
every time it is imported. NWB is a file format EASI-PASS never touches; nothing is missing
